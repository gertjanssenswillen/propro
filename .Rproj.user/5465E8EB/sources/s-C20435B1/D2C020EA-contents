#' Create Probabilistic Model (propro) using event log and Petri net
#'
#' @param eventlog An eventlog object
#' @param PN A petri net object. Should have final marking.
#'
#' @export
#'
create_propro <- function(eventlog, PN) {
    ...
    eventlog %>%
        ...
        check_fitting(net) -> complete_eventlog
